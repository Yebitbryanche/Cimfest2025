    ...
    <div>
     <nav className="bg-black/80 w-full p-4 items-center flex justify-between backdrop-blur">
        ...
        <div className="md:hidden block">
            <IoIosMenu className="text-primary" size={30} onClick={()=>setShowMenu(true)}/>
        </div>
     </nav>
     {
        showmenu && 
        <div className="absolute bg-tertiary top-0 right-0 h-full w-[70%]">
            <div className="relative">
                <IoIosClose className="text-primary absolute right-2 top-2" size={30} onClick={() => setShowMenu(false)}/>
            </div>
